...
<head>
    ...
    <body id="topOfPage">
        ...
        <main class="row min-vh-100">
            ...
            <div class= "jumbotron col-md-4 mx-auto border border-dark rounded-lg m-5 p-4">
                ...
                <form action="upload.php" method="post" enctype="multipart/form-data">
                    <div class="input-group">
                        ...
                        <label class="input-group-btn">
                            <span class="btn">
                                Select image to upload:<input type="file" class="btn" name="fileToUpload" id="fileToUpload">
                            </span>
                        </label>
                        
                        <input type="submit" class="mx-auto btn btn-outline-primary rounded-sm mt-2" value="Upload Image" name="submit">
                    </div>
                </form>
